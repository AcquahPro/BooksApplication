      ...
      <div class="box">
        ...
        <?php echo form_open('video/save');?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="videoname" placeholder="Video Name">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="videolink" placeholder="Video Link">

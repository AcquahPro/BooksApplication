  ...
  <div class="row">
    <div class="col-xs-8">
      <div class="box">
        ...
        <?php echo form_open_multipart('index.php/note/edit/'.$notedit[0]['id']);?>
            <div class="box-body">
                <div class="form-group">
                    <label for="">Class</label>
                    <select name="classlevel" class="form-control" onchange="getSubjects(this.value)" >
                        <option value="<?php echo $notedit[0]['class']; ?>"><?php echo $notedit[0]['class']; ?></option>
                ...
                <div class="form-group">
                    ...
                    <option value="<?php echo $notedit[0]['subject']; ?>"><?php echo $notedit[0]['subject']; ?></option>
                    </select>
                    <small><?php echo form_error('subject');?></small>
                </div>
                <div class="form-group">
                    <label for="">Paper Name</label>
                    <input type="text" class="form-control" name="notename" value="<?php echo $notedit[0]['notename']; ?>">
                    <small><?php echo form_error('notename');?></small>
                </div>
                <div class="form-group">
                    <label for="">Medium</label>
                    <select name="medium" class="form-control" >
                    <option value="<?php echo $notedit[0]['medium']; ?>"><?php echo $notedit[0]['medium']; ?></option>
